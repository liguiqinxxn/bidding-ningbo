        ...
        <div class="right">
          <div class="box">
            ...
            <el-form :model="form" label-width="0px">
              <el-form-item label="">
                <el-input v-model="form.username" placeholder="请输入账号" :prefix-icon="Iphone"/>
              </el-form-item>
              <el-form-item label="">
                <el-input v-model="form.password" type="password" autocomplete="off" placeholder="请输入密码" :prefix-icon="Lock"/>
              </el-form-item>
              <el-form-item>
          ...
          <div class="info">
            ...
            <div class="info-item tenderee-column">
              <span class="title">招标师专栏</span>
              <span>Tenderee column</span>
            </div>

            <div class="info-item laws-regulations">
              <span class="title">招标采购常用法规速查</span>
              <span>Quick check of common laws and <br/>
